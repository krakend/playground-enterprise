...
| Connection to WebSockets                                | [`/ws`](ws://localhost:8080/ws)                                                 | Example WebSockets implementation to illustrate WS connectivity. The WS service will just answer with the same content received. You can use a WebSockets client like [WebSocketKing](https://websocketking.com/) to check how it works.                                                                                             |
