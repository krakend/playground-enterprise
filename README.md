...
| Mocked/Static responses                                 | [`/mocked-response`](http://localhost:8080/mocked-response)                   | Returns static/mocked responses without calling real backends. Useful for development and testing without dependencies, or for implementing circuit breaker fallback responses.                                                                                                                                                       |
